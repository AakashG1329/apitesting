...
public  void testcase4(){
	...
	RestAssured.baseURI="http://localhost:3000/";
	String bodyvariable ="{\"name\":\"praveen\",\"batchno\":\"3232\"}";
	given()
...
//		System.out.println(obj);
		given().queryParam("username", "aakash").queryParam("password", "aakash123").log().all().
	...
	public Object[][] data()
	{
		...
		studentsdata [0][0]="aakash";
		studentsdata [0][1]="4";
		studentsdata [1][0]="raj";
		studentsdata [1][1]="122";
		return studentsdata;
